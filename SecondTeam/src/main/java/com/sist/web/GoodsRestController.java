...
public String goods_category_list_vue(int page, String category) throws Exception
{	
	if(category==null)
		category="전체";
	int rowSize=12;
...
public String goods_category_page_vue(int page,String category) throws Exception
{	
	Map map=new HashMap();
	map.put("category", category);
